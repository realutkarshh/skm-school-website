...
const documents = [
  ...
  },
  {
    ...
    description: "FEES STRUCTURE OF SKM PUBLIC SCHOOL",
    uploadDate: "2024-03-10",
  ...
  {
    id: "certificateC3",
    title: "LIST OF SCHOOL MANAGEMENT",
    ...
    <div className="min-h-screen py-8">
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-gray-900 mb-4">Mandatory Public Disclosure</h1>
